...
<section class="content">
    ...
    <div class="container-fluid">
        <br>
        <h3>New income candidate</h3>
        <hr>
        <!-- /.row -->
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title" style="">Form name</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <div style="border: 1px solid #cccccc;padding: 10px;">
                        ...
                        <form action="/resume-create/" method="post" target="_blank">
                            ...
                            <button type="submit" style="width: 100%" class="btn btn-outline-success">Create pdf and download</button>
                        </form>
                    </div>
                </div>
